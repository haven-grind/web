...
export default function CreateNote() {
    const { data, setData, post, reset } = useForm<Required<NoteForm>>({
        title: '',
        content: '',
    });
    ...
    return (
        <div className="flex h-screen flex-col items-center justify-center bg-black p-4 text-white">
            <h1 className="mb-8 text-4xl font-bold">Create Note</h1>
            <form onSubmit={onSubmit} className="flex w-full max-w-md flex-col gap-6 rounded-lg bg-gray-900 p-8 shadow-lg">
